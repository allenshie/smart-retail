...
!!! example "View settings"
    ...
    === "Python"
        ...
        ```python
        from third_party.yolov8.ultralytics import settings
...
|--------------------|-----------------------|-----------|------------------------------------------------------------------------------------------------------------------|
| `settings_version` | `'0.0.4'`             | `str`     | Ultralytics _settings_ version (different from third_party.yolov8.ultralytics [pip](https://pypi.org/project/ultralytics/) version) |
