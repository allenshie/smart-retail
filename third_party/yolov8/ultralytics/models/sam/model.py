...
This module provides an interface to the Segment Anything Model (SAM) from third_party.yolov8.ultralytics, designed for real-time image
...
from third_party.yolov8.ultralytics.utils.torch_utils import model_info
