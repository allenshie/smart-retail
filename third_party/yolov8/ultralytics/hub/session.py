...
from third_party.yolov8.ultralytics.hub.utils import HUB_API_ROOT, HUB_WEB_ROOT, PREFIX, smart_request
from third_party.yolov8.ultralytics.utils import LOGGER, __version__, checks, emojis, is_colab, threaded
from third_party.yolov8.ultralytics.utils.errors import HUBModelError
...
class HUBTrainingSession:
    ...
    Attributes:
        ...
        model (dict): Model data fetched from third_party.yolov8.ultralytics HUB.
    ...
    def __init__(self, url):
        ...
        from third_party.yolov8.ultralytics.hub.auth import Auth
    ...
    def _get_model(self):
        """Fetch and return model data from third_party.yolov8.ultralytics HUB."""
