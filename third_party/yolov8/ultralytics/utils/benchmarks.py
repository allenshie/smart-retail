...
Usage:
    from third_party.yolov8.ultralytics.utils.benchmarks import ProfileModels, benchmark
...
from third_party.yolov8.ultralytics.cfg import TASK2DATA, TASK2METRIC
from third_party.yolov8.ultralytics.engine.exporter import export_formats
from third_party.yolov8.ultralytics.utils import ASSETS, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR
from third_party.yolov8.ultralytics.utils.checks import check_requirements, check_yolo
from third_party.yolov8.ultralytics.utils.files import file_size
from third_party.yolov8.ultralytics.utils.torch_utils import select_device
...
class ProfileModels:
    ...
    Example:
        ```python
        from third_party.yolov8.ultralytics.utils.benchmarks import ProfileModels
