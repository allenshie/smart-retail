...
from third_party.yolov8.ultralytics.cfg import TASK2DATA, TASK2METRIC, get_save_dir
from third_party.yolov8.ultralytics.utils import DEFAULT_CFG, DEFAULT_CFG_DICT, LOGGER, NUM_THREADS
