...
from third_party.yolov8.ultralytics.hub.utils import HUB_WEB_ROOT, PREFIX, events
...
def on_fit_epoch_end(trainer):
    ...
    if session:
        ...
        if trainer.epoch == 0:
            from third_party.yolov8.ultralytics.utils.torch_utils import model_info_for_loggers
